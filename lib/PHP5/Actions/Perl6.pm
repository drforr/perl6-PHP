...
=head1 PHP5::Actions::Perl6

C<PHP5::Actions::Perl6> generates a perl6 representation of an PHP5 AST.

=head1 Synopsis

    use PHP5::Actions::Perl6;
    use PHP5::Grammar;
    my $p = PHP5::Actions::Perl6.new;
...
class PHP5::Actions::Perl6
	{
	has PHP5::Grammar $g = PHP5::Grammar.new;
	has PHP5::Actions::AST $a = PHP5::Actions::AST.new;

	my class PHP5::Actions::Perl6::Shim
		{
		has $.ast;
		has $.perl6;
		}
