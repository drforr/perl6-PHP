...
=head1 PHP7::Actions::Perl6

C<PHP7::Actions::Perl6> generates a perl6 representation of an PHP7 AST.

=head1 Synopsis

    use PHP7::Actions::Perl6;
    use PHP7::Grammar;
    my $p = PHP7::Actions::Perl6.new;
...
class PHP7::Actions::Perl6
	{
	has PHP7::Grammar $g = PHP7::Grammar.new;
	has PHP7::Actions::AST $a = PHP7::Actions::AST.new;

	my class PHP7::Actions::Perl6::Shim
		{
		has $.ast;
		has $.perl6;
		}
